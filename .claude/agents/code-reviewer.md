...
7. **Simplicity / Over-Engineering** — actively look for:
   ...
   - Wrapper classes that add no value over what they wrap
   - Config-driven behavior that's only used one way
   ...
   Flag YAGNI violations explicitly: "This [pattern] adds complexity for flexibility
